...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.main_view_title = customtkinter.CTkLabel(self, text="News", font=customtkinter.CTkFont(size=25, weight="bold"))
        self.main_view_title.grid(row=0, column=1, sticky="nsew")
    ...
    def create_articles_frames(self, url):
        ...
        for article in  self.actual_articles:
            ...
            for i in range(len(article.text) - 1):
                ...
                article_text_label.grid(row=i + grid_index, column=0, padx=(20, 20), pady=(10 if i == 0 else 0, 10), sticky="nsew")
